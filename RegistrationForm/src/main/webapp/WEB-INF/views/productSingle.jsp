			...
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light">
					<a class="navbar-brand"
						href="http://localhost:8080/registrationform/index"><img
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							<li class="navbar-item active"><a
								href="http://localhost:8080/registrationform/index"
								class="nav-link">Home</a></li>
							<li class="navbar-item"><a
								href="http://localhost:8080/registrationform/shop"
								class="nav-link">Shop</a></li>
							<li class="navbar-item"><a
								href="http://localhost:8080/registrationform/about"
								class="nav-link">About</a></li>
							<li class="navbar-item"><a
								href="http://localhost:8080/registrationform/faq"
	...
	<div class="breadcrumb">
		<div class="container">
			<a class="breadcrumb-item"
				href="http://localhost:8080/registrationform/index">Home</a> <span
				class="breadcrumb-item active">Terms and Condition</span>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row">
					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="active item carousel-item" data-slide-number="0">
								<img src="resources/images/product1.jpg" class="img-fluid">
							</div>
							<div class="item carousel-item" data-slide-number="1">
								<img src="resources/images/product2.jpg" class="img-fluid">
							</div>
							<div class="item carousel-item" data-slide-number="2">
								<img src="resources/images/product3.jpg" class="img-fluid">
							</div>
						</div>
				...
				<div class="col-md-6 slider-content">
					...
					<p>t has survived not only fiveLorem Ipsum is simply dummy text
						of the printing and typesetting industry. Lorem Ipsum has been the
						industry's printer took a galley of type and</p>
					<ul>
						<li><span class="name">ISBN</span><span class="clm">:</span>
							<span class="price">${book.isbn}</span></li>
						<li><span class="name">Publication year</span><span
							class="clm">:</span> <span class="price">${book.publicationYear}</span>
						</li>
						<li><span class="name">Price</span><span class="clm">:</span>
							<span class="price">${book.sellingPrice}</span></li>
						<li><span class="name">Category</span><span class="clm">:</span>
							<span class="price">${book.category}</span></li>
						<li><span class="name">Publisher </span><span class="clm">:</span>
							<span class="price">${book.publisherName}</span></li>
					</ul>
					<div class="btn-sec">
						<form method='post' action='addBook/${book.isbn}'>
