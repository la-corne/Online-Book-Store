	...
	<div class="breadcrumb">
		<div class="container">
			<a class="breadcrumb-item"
				...
				class="breadcrumb-item active">Visa</span>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xs-4">
				<label for="ex1">credit card number :</label> <input
					class="form-control" id="Title" type="text" required>
			</div>
			<div class="col-xs-4">
				<label for="ex2">expiry date :</label> <input class="form-control"
					id="PID" type="text" required>
			</div>
			<div class="col-xs-4">
				<div class="cart my-2 my-lg-0">
					<form action="buybuy" method="post">
			...
			<div class="col-xs-4">
				<p>
					<font color="red">${negativeStock}</font>
				</p>
			</div>
		</div>
	</div>
