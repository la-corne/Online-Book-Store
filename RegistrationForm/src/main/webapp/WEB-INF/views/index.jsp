...
<body>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							...
							<li class="navbar-item"><a
								href="http://localhost:8080/registrationform/viewUserSettingsPage"
	...
	<section class="slider">
		<div class="container">
			<div id="owl-demo" class="owl-carousel owl-theme">
							...
							<div class="title">
								...
								<c:choose>
									<c:when test="${p.isManager == 1}">
										<form action="clickAddBookbutton" method="post">
				...
				<div class="item">
					<div class="slide">
						<img src="resources/images/slide2.jpg" alt="slide1">
						<div class="content">
							<div class="title">
								<h3>welcome to bookstore</h3>
								<h5>Discover the best books online with us</h5>
								...
								<c:choose>
									<c:when test="${p.isManager == 1}">
										<form action="orders" method="post">
											<input type="submit" class="btn" value="books'orders">
										</form>
									</c:when>
								</c:choose>							
				...
				<div class="item">
					<div class="slide">
						<img src="resources/images/slide3.jpg" alt="slide1">
						<div class="content">
							<div class="title">
								<h3>welcome to bookstore</h3>
								<h5>Discover the best books online with us</h5>
								<a href="http://localhost:8080/registrationform/shop" class="btn">shop books</a>
							</div>
						</div>
					</div>
				</div>
				<div class="item">
					<div class="slide">
						<img src="resources/images/slide4.jpg" alt="slide1">
						<div class="content">
							<div class="title">
								<h3>welcome to bookstore</h3>
								<h5>Discover the best books online with us</h5>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="item">
						<img src="resources/images/img1.jpg" alt="img">
						<h3>how to be a bwase</h3>
						<h6>
							<span class="price">$49</span> / <a href="#">Buy Now</a>
						</h6>
						<div class="hover">
				...
				<div class="col-lg-3 col-md-6">
					<div class="item">
						<img src="resources/images/img2.jpg" alt="img">
						<h3>How to write a book...</h3>
						<h6>
							<span class="price">$19</span> / <a href="#">Buy Now</a>
						</h6>
				...
				<div class="col-lg-3 col-md-6">
					<div class="item">
						<img src="resources/images/img3.jpg" alt="img">
				...
				<div class="col-lg-3 col-md-6">
					<div class="item">
						<img src="resources/images/img4.jpg" alt="img">
						<h3>wendy doniger</h3>
						<h6>
							<span class="price">$49</span> / <a href="#">Buy Now</a>
						</h6>
	...
	<section class="about-sec">
		<div class="about-img">
			<figure
				style="background: url(.resources/images/about-img.jpg) no-repeat;"></figure>
		</div>
		<div class="about-content">
			<h2>About bookstore,</h2>
			<p>Lorem Ipsum is simply dummy text of the printing and
				typesetting industry. Lorem Ipsum has been the industry's printer
				took a galley of type and Scrambled it to make a type and
				typesetting industry. Lorem Ipsum has been the book.</p>
			<p>It has survived not only fiveLorem Ipsum is simply dummy text
				of the printing and typesetting industry. Lorem Ipsum has been the
				industry's printer took a galley of type and</p>
			<div class="btn-sec">
				<a href="http://localhost:8080/registrationform/shop" class="btn yellow">shop books</a> <a
					href="" class="btn black">subscriptions</a>
			</div>
		</div>
	</section>
	<section class="recent-book-sec">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="item">
						<img src="resources/images/r2.jpg" alt="img">
						<h3>
							<a href="#">Keepers of the kalachakara</a>
						</h3>
						<h6>
				...
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="item">
						<img src="resources/images/r3.jpg" alt="img">
						<h3>
							<a href="#">Keepers of the kalachakara</a>
						</h3>
						<h6>
				...
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="item">
						<img src="resources/images/r4.jpg" alt="img">
						<h3>
							<a href="#">Keepers of the kalachakara</a>
						</h3>
						<h6>
				...
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="item">
						<img src="resources/images/r5.jpg" alt="img">
						<h3>
							<a href="#">Keepers of the kalachakara</a>
						</h3>
						<h6>
			...
			<div class="btn-sec">
				<a href="http://localhost:8080/registrationform/shop" class="btn gray-btn">view all books</a>
			</div>
		</div>
	</section>
	<section class="features-sec">
		<div class="container">
			<ul>
				<li><span class="icon"><i class="fa fa-shopping-cart"
						aria-hidden="true"></i></span>
					<h3>SAFE SHOPPING</h3>
					<h5>Safe Shopping Guarantee</h5>
					<h6>Lorem Ipsum is simply dummy text of the printing and
						typesetting industry. Lorem Ipsum has been the industry's...</h6></li>
				<li><span class="icon return"><i class="fa fa-reply-all"
						aria-hidden="true"></i></span>
					<h3>30- DAY RETURN</h3>
					<h5>Moneyback guarantee</h5>
					<h6>Lorem Ipsum is simply dummy text of the printing and
						typesetting industry. Lorem Ipsum has been the industry's...</h6></li>
				<li><span class="icon chat"><i class="fa fa-comments"
						aria-hidden="true"></i></span>
					<h3>24/7 SUPPORT</h3>
	...
	<section class="offers-sec"
		style="background: url(resources/images/offers.jpg) no-repeat;">
		<div class="cover"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="detail">
						...
						<h6>We are now offering some good discount on selected books
							go and shop them</h6>
						<a href="http://localhost:8080/registrationform/shop" class="btn blue-btn">view all books</a> <span
							class="icon-point percentage"> <img
							src="resources/images/precentagae.png" alt="">
						</span>
					</div>
				</div>
				<div class="col-md-6">
					<div class="detail">
						...
						<h6>We are now offering some good discount on selected books
							go and shop them</h6>
						<a href="http://localhost:8080/registrationform/shop" class="btn blue-btn">view all books</a> <span
							class="icon-point amount"><img
							src="resources/images/amount.png" alt=""></span>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="testimonial-sec">
			...
			<div id="testimonal" class="owl-carousel owl-theme">
				<div class="item">
					<h3>Lorem Ipsum is simply dummy text of the printing and
						typesetting industry. Lorem Ipsum has been the industry's printer
						took a galley of type and Scrambled it to make a type and
						typesetting industry. been the book</h3>
					<div class="box-user">
		...
		<div class="left-quote">
			<img src="resources/images/left-quote.png" alt="quote">
		</div>
		<div class="right-quote">
			<img src="resources/images/right-quote.png" alt="quote">
		</div>
	</section>
	<footer>
		<div class="container">
