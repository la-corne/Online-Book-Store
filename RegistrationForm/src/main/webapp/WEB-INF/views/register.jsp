...
<body>
	...
	<section class="static about-sec">
		<div class="container">
			...
			<div class="form">
				<p>
					<font color="red">${invalidregistrationusername}</font>
				</p>
				<form method='post' action='clickregistrationbutton'>
					<div class="row">
						<div class="col-md-4">
							<input name='name' path="name" placeholder="User Name">
							<span class="required-star">*</span>
						</div>
						<div class="col-md-4">
							<input name='fname' placeholder="First Name"> <span
								class="required-star">*</span>
						</div>
						<div class="col-md-4">
							<input name='lname' placeholder="Last Name"> <span
								class="required-star">*</span>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-4">
							<input name='phoneNumber' placeholder="Phone Number"> <span
								class="required-star">*</span>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-4">
							...
							<label> Manager<input style="font-size: 50%" type="radio"
								name="isManager" value=1></label> <label> Customer<input
								type="radio" name="isManager" value=0 checked></label>
						</div>
						<div class="col-lg-8 col-md-12">
							<button class="btn black">Register</button>
							<h5>
								Registered? <a
									href="http://localhost:8080/registrationform/login">Login
									here</a>
							</h5>
						</div>
					</div>
