...
<body>
	...
	<section class="static about-sec">
		<div class="container">
			...
			<table width='100%' cellpadding='1' class='table-bordered active'>
				<tr>
					<th>Order Id</th>
					<th>Book ISBN</th>
				...
				<c:forEach var='order' items='${orderslist}'>
					<tr>
						...
						<td style="background-color:white;"><a href='deleteorder/${order.orderId}' class='btn btn-danger'>Delete</a></td>
					</tr>
				</c:forEach>
			</table>
