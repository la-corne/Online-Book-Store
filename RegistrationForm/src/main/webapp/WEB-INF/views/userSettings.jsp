	...
	<div class="breadcrumb">
		<div class="container">
			<a class="breadcrumb-item" href="http://localhost:8080/registrationform/index">Home</a> <span
				class="breadcrumb-item active">Settings</span>
		</div>
	</div>
	<section class="static about-sec">
		<div class="container">
			<form method='post' action='savebuttonisclicked'>
				<table>
					<tr>
						<td>User Name</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px;"
							name='name' path="name" placeholder="${p.name}" ></td>
					</tr>
					<tr>
						<td>First Name</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px; background-color: #FFB74D;"
							name='fname' placeholder="${p.fname}"></td>
					</tr>
					<tr>
						<td>Last Name</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px;"
							name='lname' placeholder="${p.lname}"></td>
					</tr>
					<tr>
						<td>Password</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px; background-color: #FFB74D;"
							name='password' placeholder="${p.password}"></td>
					</tr>
					<tr>
						<td>Email</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px;"
							name='email' placeholder="${p.email}"></td>
					</tr>
					<tr>
						<td>Phone Number</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px; background-color: #FFB74D;"
							name='phoneNumber' placeholder="${p.phoneNumber}"></td>
					</tr>
					<tr>
						<td>Shipping Address</td>
						<td><input
							style="width: 70%; margin: 8px 0; border: none; border-radius: 4px;"
							name='shippingAddress' placeholder="${p.shippingAddress}"></td>
					</tr>
				</table>
				<br>
				<button class="btn"
